...
public class ComplaintActivity extends AppCompatActivity
    ...
    EditText editTextNature;
    EditText editTextDescription;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        buttonComplaint = findViewById(R.id.button_complaint);
        buttonEmergency = findViewById(R.id.button_emergency);
        editTextNature = findViewById(R.id.edittext_nature);
    ...
    public void onComplaintButtonClick(View view){
        ...
        final View v =getLayoutInflater().inflate(R.layout.dialog_complaint,null);
        builder.setView(v);
        builder.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                String nature = editTextNature.getText().toString();
                String description = editTextDescription.getText().toString();
                Toast.makeText(ComplaintActivity.this, nature+" "+description, Toast.LENGTH_SHORT).show();
            }
        });
